...
func createStory(adventureStoryList: StoryList){
    ...
    adventureStoryList.addNode(storyPlot: "You make your way carefully down the hill after quite a bit of time", rightStory: "Still follow the smoke", leftStory: "Follow the river instead", key: 2600, gameOver: false, gameOverStory: "", pictureFile: "hill")
    adventureStoryList.addNode(storyPlot: "You make your way carefully down the hill after quite a bit of time", rightStory: "Still follow the river", leftStory: "Follow the smoke instead", key: 2450, gameOver: false, gameOverStory: "", pictureFile: "hill")
    ...
    adventureStoryList.addNode(storyPlot: "You save energy just treading water. Luckily, the river lulls to a slow. Lost and tired, You walk until your feet are sore but suddenly the scene of a village reveals itself from the foliage. A primitive looking man approaches from a hut and offers you a large cooked insect", rightStory: "Take the insect", leftStory: "Refuse the insect", key: 850, gameOver: false, gameOverStory: "", pictureFile: "hut")
