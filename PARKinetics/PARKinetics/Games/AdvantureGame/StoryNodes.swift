...
func createStory(){
    ...
    AdventureStory1.addNode(storyPlot: "After some searching you come across a stream rife with leaping fish", rightStory: "Prepare a trap", leftStory: "Try to catch a fish", key: 900)
